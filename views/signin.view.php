...
<body class="bg-bg-light text-secondary-dark font-sans min-h-screen flex flex-col">
  ...
  <main class="flex flex-col w-full mx-4 my-16 tablet:mx-auto tablet:max grow">
    ...
    <section class="flex flex-col justify-center border-secondary-dark border-2 w-10/12 mx-auto my-8 p-4 laptop:w-7/12 desktop:max-w-2xl laptop:p-10">
      ...
      <form class="flex flex-col self-center my-10 w-11/12 text-secondary-dark" action="/signin" method="POST">
        <label for="user-verify" class="ms-4">Username</label>
        <input name="user" type="text" class="m-2 rounded-md text-gray-700 border-secondary-dark border-2 p-1.5">
        <label for="password-verify" class="ms-4">Password</label>
        <input type="password" id="password-verify" name="password" class="m-2 rounded-md text-gray-700 border-secondary-dark border-2 p-1.5">
