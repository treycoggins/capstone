...
<body class="bg-bg-light text-primary font-sans relative overflow-x-hidden">
  ...
  <main class="relative">
    ...
    <section id="section-members" class="text-center my-4 relative">
      ...
      <a tabindex="3" href="/register" class="cta-btn bg-primary text-secondary-light rounded-full px-10 py-4 mt-4 mx-auto text-center shadow-black border-secondary-dark tracking-wider">Sign
        up now!</a>
